package guco.sfe.freemarker.config;
...
public class Configuration extends freemarker.template.Configuration {
    ...
    public Configuration(TemplateLoader templateLoader) {
        this(DEFAULT_INCOMPATIBLE_IMPROVEMENTS);
        this.remoteTemplateLoader = templateLoader;
    }
    ...
    private void setSharedVariablesFromRewrappableSharedVariables() throws TemplateModelException {
        ...
        for (Iterator it = rewrappableSharedVariables.entrySet().iterator(); it.hasNext(); ) {
            Map.Entry/*<String, Object>*/ ent = (Map.Entry) it.next();
