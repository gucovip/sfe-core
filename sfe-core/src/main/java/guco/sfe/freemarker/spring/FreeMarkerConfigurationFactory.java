package guco.sfe.freemarker.spring;
...
public class FreeMarkerConfigurationFactory {
    ...
    private TemplateLoader remoteTemplateLoader;

    public TemplateLoader getRemoteTemplateLoader() {
        return remoteTemplateLoader;
    }

    public void setRemoteTemplateLoader(TemplateLoader remoteTemplateLoader) {
        this.remoteTemplateLoader = remoteTemplateLoader;
    }
    ...
    public Configuration createConfiguration() throws IOException, TemplateException {
        Configuration config = newConfiguration(remoteTemplateLoader);
        ...
        if (remoteTemplateLoader != null) {
            templateLoaders.add(remoteTemplateLoader);
        }
    ...
    protected Configuration newConfiguration(TemplateLoader templateLoader) throws IOException, TemplateException {
